...
### script.skin.helper.colorpicker.bg
...
```
RunScript(script.skin.helper.colorpicker.bg,skinstring=XXX)
```
...
For example: RunScript(script.skin.helper.colorpicker.bg,skinstring=MySkinString,header=Set the OSD Foreground Color)
...
RunScript(script.skin.helper.colorpicker.bg,winproperty=XXX)
...
RunScript(script.skin.helper.colorpicker.bg,shortcutproperty=XXX)
...
```
RunScript(script.skin.helper.colorpicker.bg,skinstring=MySkinString,palette=mypalette1)
```
